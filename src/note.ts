...
abstract class AbstractNote {
    ...
    constructor(note_text: string, fields_dict: FIELDS_DICT, curly_cloze: boolean, highlights_to_cloze: boolean, formatter: FormatConverter, cloze_keyword: string) {
        ...
        this.cloze_keyword = cloze_keyword
    }
    ...
    getFields(): Record<string, string> {
        ...
        for (let key in fields) {
            fields[key] = this.formatter.format(
                fields[key].trim(),
                this.note_type.includes(this.cloze_keyword) && this.curly_cloze,
